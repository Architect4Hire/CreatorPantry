...
aws cloudformation decp-stacks --stack-name "<stack-name>"
aws cloudformation decp-stack-events --stack-name "<stack-name>" --max-items 20
...
aws ecs decp-services --cluster "<cluster-name>" --services "<service-name>"
...
# ElastiCache
aws elasticache decp-cache-clusters --show-cache-node-info
```
