...
/// </para>
/// <para>
/// This creates the recipe, not its contents. Ingredients, steps and equipment are edited through their own
/// contract, which has ordering and concurrency concerns this one does not.
/// </para>
/// </remarks>
