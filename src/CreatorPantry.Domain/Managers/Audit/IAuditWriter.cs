...
/// payloads — see <see cref="CreatorPantry.Domain.Managers.Audit.AuditLog"/>'s remarks.
/// </summary>
...
{
    /// <summary>
    /// Stages an <see cref="CreatorPantry.Domain.Managers.Audit.AuditLog"/> row on the ambient DbContext without saving, so it commits in the
